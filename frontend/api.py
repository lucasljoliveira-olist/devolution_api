...
api.add_resource(DevolutionProductOrderResource, '/api/devolution/devolution_product_order/<int:id>', endpoint='devolution_product_order')
...
api.add_resource(DevolutionReasonResource, '/api/devolution/devolution_reason/<int:id>', endpoint='devolution_reason')
api.add_resource(DevolutionReasonResource, '/api/devolution/devolution_reason', endpoint='devolution_reasons')

api.add_resource(DevolutionResource, '/api/devolution/<int:id>', endpoint='devolution')
api.add_resource(DevolutionResource, '/api/devolution', endpoint='devolutions')

api.add_resource(DevolutionStatusResource, '/api/devolution/devolution_status/<int:id>', endpoint='devolution_status')
api.add_resource(DevolutionStatusResource, '/api/devolution/devolution_status', endpoint='devolution_statuss')

api.add_resource(DevolutionTypeResource, '/api/devolution/devolution_type/<int:id>', endpoint='devolution_type')
